...
export default function Contact() {
  ...
  const { ref: gridRef, isInView: gridInView } = useInView({ threshold: 0.15 });
  ...
  return (
    <section className="section contact" id="contacto" aria-labelledby="contact-title">
      <div className="container">
        <header
          ref={headerRef}
          className={`contact__header reveal${headerInView ? " reveal--visible" : ""}`}
        >
        ...
        <div
          ref={gridRef}
          className={`contact__grid reveal${gridInView ? " reveal--visible" : ""}`}
        >
          <aside className="contact__aside">
            <div className="contact__aside-card">
              <figure className="contact__figure">
                <img
                  src={MARKETING_IMAGES.contactAmbient.src}
                  alt={MARKETING_IMAGES.contactAmbient.alt}
